## Welcome to the BTT AJL Biotin Team Repo! 
...
- [Samantha Quan](https://github.com/samanthaquan)
- Chelsey Parker
- Alexis Evans
- [Nasrin Ali](https://github.com/nasrina081)
- [Jawad Rada](https://github.com/jawadrada)
- [Jawad Kabir](https://github.com/joewadk)

## Project Highlights

## Project Overview:
The Equitable AI for Dermatology competition challenged students to create a machine learning model that classifies 21 different skin conditions across diverse skin tones and addresses historical bias of those typically excluded from AI models. Break Through Tech AI Fellows from the Virtual, Boston (MIT), and Los Angeles (UCLA) programs competed to see whose model could most accurately assess skin conditions. Due to a lack of diverse training data in dermatology AI tools, people with darker skin tones are often misdiagnosed which can lead to delayed treatments and health disparities for those groups. The competition seeks to address this issue by building an inclusive machine learning model for dermatology.
...
![image](https://github.com/user-attachments/assets/58100f92-d0db-4ded-8f6f-960ac2f3660a)

![image](https://github.com/user-attachments/assets/92ac2e11-ec58-463b-8c0c-a927a67ce916)
